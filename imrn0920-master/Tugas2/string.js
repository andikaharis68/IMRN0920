...
var secondWord  = secondWord3.length
var thirdWord =  thirdWord3.length
var fourthWord = fourthWord3.length
var fifthWord = fifthWord3.length
// lanjutkan buat variable lagi di bawah ini 
console.log('First Word: ' + exampleFirstWord3 + ', with length: ' + firstWordLength); 
console.log('Second Word: ' + secondWord3  + ', with length: ' + secondWord); 
console.log('Third Word: ' + thirdWord3 + ', with length: ' + thirdWord); 
console.log('Fourth Word: ' + fourthWord3 +', with length: ' + fourthWord); 
console.log('Fifth Word: ' + fifthWord3 + ', with length: ' + fifthWord); 
